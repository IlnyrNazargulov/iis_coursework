...
namespace seller_client.models
{
    ...
    class ClientAssemblyDetails
    {
        ...
        [Association(Storage = "_clientOrder", IsForeignKey = true, ThisKey = "clientOrderId", OtherKey = "id")]
        ...
        [Association(Storage = "_computerComponent", IsForeignKey = true, ThisKey = "computerComponentId", OtherKey = "id")]
